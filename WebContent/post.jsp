...
<link rel="stylesheet" type="text/css" href="views/styles/news_styles.css">
<link rel="stylesheet" type="text/css" href="views/styles/news_responsive.css">
<link rel="stylesheet" type="text/css" href="views/styles/elements_styles.css">
<link rel="stylesheet" type="text/css" href="views/styles/elements_responsive.css">
</head>
<body>
<div class="super_container">
						...
						<nav class="main_nav ml-auto">
							<ul class="main_nav_list">
								...
								<%
									...
									if(user==null){
								%>
								<li class="main_nav_item active"><a href="BlogController?action=view">Blogs</a></li>
								<%
		...
		<div class="menu_inner menu_mm">
			<div class="menu menu_mm">
				...
				<ul class="menu_list menu_mm">
					...
					<li class="menu_item menu_mm"><a href="contact.jsp">Contact</a></li>
				</ul>
	...
	<div class="home">
		...
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="views/images/news.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
						...
						<div class="home_content_inner">
							...
							<div class="home_breadcrumbs">
								<ul class="home_breadcrumbs_list">
									<li class="home_breadcrumb"><a href="index.jsp">Home</a></li>
									<li class="home_breadcrumb">Blogs</li>
								</ul>
								<%
								if(firstname!=null){
								%>
								<form action="new_post.jsp">
									<input type="hidden" name="author" value="${firstname}"/>
									<button type="submit" id="newsletter_button" class="newsletter_button" style="margin-left: 1000px;">Create New Post</button>
								</form>
								<%
								}
								%>
	...
	<div class="find">
		...
		<div class="find_background_container prlx_parent">
			<div class="find_background prlx" style="background-image:url(views/images/find.jpg)"></div>
		</div>
			...
			<div class="row">
				...
				<div class="col-lg-9">
					<div class="news_posts">
						<div class="news_post">
							<div class="post_title"><a href="${pageContext.request.contextPath}/BlogController?id=${post[0].title}">${post[0].title}</a></div>
							<div class="post_meta">
								<ul>
									<li><a href="#">by ${post[0].author}</a></li>
									<li>${post[0].dated}</li>
									<li><a href="post.jsp">${post.size()} comments</a></li>
								</ul>
							</div>
							<div class="post_image">
								<img src="${post[0].paths}" alt="https://unsplash.com/@simonmigaj">
								<a href="#"><div class="post_image_box text-center">+</div></a>
							</div>
							<div class="post_text">
								<p>${post[0].content_l}</p>
							</div>
						</div>
						<h1>COMMENTS</h1>
						<c:forEach items="${post}" var="post">
						<p>Comment by: ${post.author}</p>
						<p>${post.comment} <i class="fa fa-heart"></i></p>
						</c:forEach>
						<div class="buttons">
							<div class="container">
								<div class="row">
									<div class="col">
										<div class="buttons_container">
											<div class="button button_1 elements_button"><a href="#">Add Comment</a></div>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="sidebar">
						...
						<div class="sidebar_featured">
							...
							<div class="sidebar_featured_post">
								<div class="sidebar_featured_image"><img src="views/images/sidebar_featured_1.jpg" alt=""></div>
								<div class="sidebar_featured_title"><a href="#">Top destinations in Europe</a></div>
								<div class="sidebar_featured_meta">
									<ul>
										<li><a href="#">by Akhil</a></li>
							...
							<!-- Featured Post -->
							<div class="sidebar_featured_post">
								<div class="sidebar_featured_image"><img src="views/images/sidebar_featured_2.jpg" alt=""></div>
								<div class="sidebar_featured_title"><a href="#">Best beaches in the world</a></div>
								<div class="sidebar_featured_meta">
									<ul>
										<li><a href="#">by Nikhil</a></li>
										<li>january 31, 2018</li>
										<li><a href="#">3 comments</a></li>
									</ul>
								</div>
							...
							<!-- Featured Post -->
							<div class="sidebar_featured_post">
								<div class="sidebar_featured_image"><img src="views/images/sidebar_featured_3.jpg" alt=""></div>
								<div class="sidebar_featured_title"><a href="#">Best beaches in the world</a></div>
								<div class="sidebar_featured_meta">
									<ul>
										<li><a href="#">by Abhishek</a></li>
										<li>january 31, 2018</li>
										<li><a href="#">3 comments</a></li>
									</ul>
								</div>
						...
						<div class="sidebar_offers">
							...
							<div class="sidebar_offer">
								<div class="sidebar_offer_background" style="background-image:url(views/images/offer_1.jpg)"></div>
								<div class="sidebar_offer_content">
									...
									<div class="sidebar_offer_button"><a href="offers.jsp">See Offer</a></div>
								</div>
							</div>

							<!-- Offer -->
							<div class="sidebar_offer">
								<div class="sidebar_offer_background" style="background-image:url(views/images/offer_2.jpg)"></div>
								<div class="sidebar_offer_content">
									<div class="sidebar_offer_destination">bali</div>
						...
						<div class="sidebar_quote">
							<div class="quote_box"><img src="views/images/quote.png" alt=""></div>
	...
	<c:forEach items="${post}" var="post">
					<div class="accordions_tabs">
						<div class="container">
							<div class="row">
								<div class="col">
									<div class="elements_title">Comment</div>
								</div>
							</div>
								...
								<div class="col-lg-6">
									<div class="accordions_content">
										<div class="accordion_container">
											<div class="accordion d-flex flex-row align-items-center"><div>${post.comment}</div></div>
						...
						<div class="footer_latest_content">
							...
							<div class="footer_latest_item">
								...
								<div class="footer_latest_item_content">
									<div class="footer_latest_item_title"><a href="news.jsp">Brazil Summer</a></div>
							...
							<div class="footer_latest_item">
								...
								<div class="footer_latest_item_content">
									<div class="footer_latest_item_title"><a href="news.jsp">A perfect vacation</a></div>
									<div class="footer_latest_item_date">Jan 09, 2018</div>
								</div>
							</div>
...
<script src="views/js/news_custom.js"></script>
</body>
</html>
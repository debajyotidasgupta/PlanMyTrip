          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="room-img" style="background-image: url(views/images/room-4.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="room-img" style="background-image: url(views/images/room-5.jpg);"></div>
          				</div>
          				<div class="item">
          					<div class="room-img" style="background-image: url(views/images/room-6.jpg);"></div>
          				</div>
          			</div>
          		</div>
          		<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
          			<h2 class="mb-4">${hotel[0].rtype} <span>- (${hotel[0].ravail} Available rooms)</span></h2>
    						<p>${hotel[0].rdesc}</p>
    						<div class="d-md-flex mt-5 mb-5">
    							<ul class="list">
	    							<li><span>Max:</span> ${hotel[0].rmax} Persons</li>
	    							<li><span>Size:</span> ${hotel[0].rsize} m2</li>
	    						</ul>
	    						<ul class="list ml-md-5">
	    							<li><span>View:</span> ${hotel[0].rview} View</li>
	    							<li><span>Bed:</span> ${hotel[0].rbed}</li>
	    						</ul>
    						</div>
          		...
          		<div class="col-md-12 room-single ftco-animate mb-5 mt-4">
          			...
          			<div class="block-16">
		              <figure>
		                <img src="views/images/room-4.jpg" alt="Image placeholder" class="img-fluid">
          ...
          <div class="col-lg-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              <div class="categories">
                ...
                <li><a href="#">${hotel.tag}<span>(10)</span></a></li>
                </c:forEach>
            ...
            <div class="sidebar-box ftco-animate">
              ...
              if(user!=null && user.equals("tourist")){
              %>

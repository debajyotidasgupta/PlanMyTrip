<%@page import="javax.jdo.FetchGroup"%>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9">
					...
					<div class="news_post">
							<div class="post_title"><a href="${pageContext.request.contextPath}/BlogController?title=${post.title}">${post.title}</a></div>
							<div class="post_meta">
								<ul>
									<li><a href="#">by ${post.author}</a></li>
									<li>${post.dated}</li>
									<li><a href="post.jsp">1 comments</a></li>
								</ul>
							</div>
							<div class="post_image">
								<img src="${post.paths}" alt="https://unsplash.com/@simonmigaj">
						...
						<div class="news_post">
							...
							<div class="post_meta">
								<ul>
									<li><a href="#">by Abhimanyu</a></li>
									<li>january 31, 2018</li>
									<li><a href="post.jsp">3 comments</a></li>
								</ul>
							</div>
							<div class="post_image">
								<img src="views/images/news_1.jpg" alt="https://unsplash.com/@simonmigaj">
								<a href="#"><div class="post_image_box text-center">+</div></a>
							</div>
							<div class="post_text">
						...
						<div class="news_post">
							...
							<div class="post_meta">
								<ul>
									<li><a href="#">by Aniket</a></li>
									<li>january 31, 2018</li>
									<li><a href="#">3 comments</a></li>
								</ul>
							</div>
							<div class="post_image">
								<img src="views/images/news_2.jpg" alt="https://unsplash.com/@mfggomez">
								<a href="#"><div class="post_image_box text-center">+</div></a>
							</div>
							<div class="post_text">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce fringilla lectus nec diam auctor, ut fringilla diam sagittis. Quisque vel est id justo faucibus dapibus id a nibh. Aenean suscipit consequat lacus, sit amet mollis nulla. Morbi sagittis orci id lacus convallis tempus eget sit amet metus.</p>
						...
						<div class="news_post">
							...
							<div class="post_meta">
								<ul>
									<li><a href="#">by Pratyay</a></li>
									<li>january 31, 2018</li>
									<li><a href="#">3 comments</a></li>
								</ul>
							</div>
							<div class="post_image">
								<img src="views/images/news_3.jpg" alt="https://unsplash.com/@claudiotrigueros">
								<a href="#"><div class="post_image_box text-center">+</div></a>
							</div>
							<div class="post_text">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce fringilla lectus nec diam auctor, ut fringilla diam sagittis. Quisque vel est id justo faucibus dapibus id a nibh. Aenean suscipit consequat lacus, sit amet mollis nulla. Morbi sagittis orci id lacus convallis tempus eget sit amet metus.</p>

...
<html>
    <head>
        ...
        <link rel="stylesheet" href="views/css/hero-slider.css">
        <link rel="stylesheet" href="views/css/owl-carousel.css">
        <link rel="stylesheet" href="views/css/datepicker.css">
        <link rel="stylesheet" href="views/css/tooplate-style.css">

        <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800" rel="stylesheet">

        <script src="views/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js"></script>
    </head>
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <div class="left-side">
                        <div class="logo">
                            <img src="views/img/logo.png" alt="Flight Template">
                        </div>
                    ...
                    <section id="first-tab-group" class="tabgroup">
                        <div id="tab1">
                            <div class="submit-form">
                                ...
                                <form id="form-submit" action="FlightController?action=view" method="get">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <fieldset>
        ...
        <div class="container">
            <div class="row">
                ...
                <%
					...
					if(h!=null && (h.equals("flight") || h.equals("admin"))){
				%>
		    	<div class = "page-direction-button" style="align:center;"><a href="addFlight.jsp" class="btn-custom px-3 py-2">Add New Flight</a></div>
		    	<div class = "page-direction-button" style="align:center;"><a href="FlightController?action=view" class="btn-custom px-3 py-2">List All Flight</a></div>
		    	<%
					}
				%>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="weather-item">
                                                        ...
                                                        <div class="weather-icon">
                                                            <img src="views/img/weather-icon-03.png" alt="">
                                                        </div>
                                                        <span>32&deg;C</span>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="weather-item">
                                                        <h6>Thailand</h6>
                                                        <div class="weather-icon">
                                                            <img src="views/img/weather-icon-02.png" alt="">
                                                        </div>
                                                        <span>28&deg;C</span>
                                                        <ul class="time-weather">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="weather-item">
                                                        <h6>India</h6>
                                                        <div class="weather-icon">
                                                            <img src="views/img/weather-icon-01.png" alt="">
                                                        </div>
                                                        <span>33&deg;C</span>
                                                        <ul class="time-weather">
                                                            <li>6AM <span>26&deg;</span></li>
                ...
                <div class="wrapper">
                    ...
                    <div class="col-md-8">
                        <section id="third-tab-group" class="recommendedgroup">
                                        ...
                                        <div id="owl-suiteroom" class="owl-carousel owl-theme">
                                            <div class="item">
                                                <div class="suiteroom-item">
                                                    <img src="views/img/suite-02.jpg" alt="">
                                                    <div class="text-content">
                                            ...
                                            <div class="item">
                                                <div class="suiteroom-item">
                                                    <img src="views/img/suite-01.jpg" alt="">
                                                    <div class="text-content">
                                            ...
                                            <div class="item">
                                                <div class="suiteroom-item">
                                                    <img src="views/img/suite-03.jpg" alt="">
                                                    <div class="text-content">
                            ...
                            <div id="swimingpool">
                                <img src="views/img/swiming-pool.jpg" alt="">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="text-content">
                            ...
                            <div id="massage">
                                <img src="views/img/massage-service.jpg" alt="">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="text-content">
                            ...
                            <div id="fitness">
                                <img src="views/img/fitness-service.jpg" alt="">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="text-content">
                            ...
                            <div id="event">
                                <img src="views/img/evening-event.jpg" alt="">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="text-content">
                    ...
                    <div id="owl-mostvisited" class="owl-carousel owl-theme">
                        <div class="item col-md-12">
                            <div class="visited-item">
                                <img src="views/img/place-01.jpg" alt="">
                                <div class="text-content">
                                    <h4>River Views</h4>
                                    <span>New York</span>
                                </div>
                        ...
                        <div class="item col-md-12">
                            <div class="visited-item">
                                <img src="views/img/place-02.jpg" alt="">
                                <div class="text-content">
                        ...
                        <div class="item col-md-12">
                            <div class="visited-item">
                                <img src="views/img/place-03.jpg" alt="">
                                <div class="text-content">
                        ...
                        <div class="item col-md-12">
                            <div class="visited-item">
                                <img src="views/img/place-04.jpg" alt="">
                                <div class="text-content">
    ...
    <script>window.jQuery || document.write('<script src="views/js/vendor/jquery-1.11.2.min.js"><\/script>')</script>
    ...
    <script src="views/js/fmain.js"></script>
